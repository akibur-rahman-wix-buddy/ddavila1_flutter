...
Future<void> setInitValue() async {
  ...
  //await appData.writeIfNull(kKeyIsOnboarding, true);
//  await appData.writeIfNull(kKeyIsSelectLanguage, true);
...
// void logout() async {
//   await getLogoutRXObj.logout().then((e) {
//     NavigationService.navigateToRemoveuntil(Routes.login);
//   });
// }
  ...
  showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
            ...
            actions: <Widget>[CustomButton(
              ...
              minWidth: .3.sw,
              borderRadius: 30.r,
              color: AppColor.allPrimaryColor,
