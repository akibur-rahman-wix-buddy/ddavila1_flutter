...
final class LiveAuctionDataRx extends RxResponseInt<LiveAuctionApiDataModel> {
  final api = LiveAuctionApi.instance;

  LiveAuctionDataRx({required super.empty, required super.dataFetcher});

  ValueStream get getAvailableItemsStream => dataFetcher.stream;

  Future<LiveAuctionApiDataModel?> liveAuctionDataInfo() async {
    try {
      final  data = await api.liveAuctionData();
