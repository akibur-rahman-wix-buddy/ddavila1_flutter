...
// //     bids: json["bids"] == null ? [] : List<BidData>.from(json["bids"]!.map((x) => BidData.fromJson(x))),
...
// //   });
// //
// //   factory BidData.fromRawJson(String str) => BidData.fromJson(json.decode(str));
// //
// //   String toRawJson() => json.encode(toJson());
// //
...
//   bool? success;
//   String? message;
//   List<ProductData>? data; // Changed to List<Data> to match typical API response
//   int? code;
//
//   LiveAuctionDetailsApiDataModel({
//     this.success,
...
//   });
//
//   factory LiveAuctionDetailsApiDataModel.fromRawJson(String str) =>
//       LiveAuctionDetailsApiDataModel.fromJson(json.decode(str));
//
//   String toRawJson() => json.encode(toJson());
//
//   factory LiveAuctionDetailsApiDataModel.fromJson(Map<String, dynamic> json) =>
//       LiveAuctionDetailsApiDataModel(
//         success: json["success"],
//         message: json["message"],
//         data: json["data"] == null
...
//     bids: json["bids"] == null
//         ? []
//         : List<BidData>.from(json["bids"]!.map((x) => BidData.fromJson(x))),
...
class LiveAuctionDetailsApiDataModel {
  bool? success;
  String? message;
  ProductData? data; // Changed from List<ProductData> to ProductData
  int? code;
