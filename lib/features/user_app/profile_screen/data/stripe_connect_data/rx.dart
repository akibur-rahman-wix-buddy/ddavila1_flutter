...
final class StripeConnectRx extends RxResponseInt<StripeConnectDataModel> {
  final api = StripeConnectApi.instance;

  StripeConnectRx({required super.empty, required super.dataFetcher});

  ValueStream get getAvailableItemsStream => dataFetcher.stream;

  Future<StripeConnectDataModel?> stripeConnectInfo() async {
    try {
      final  data = await api.stripeConnectInfo();
