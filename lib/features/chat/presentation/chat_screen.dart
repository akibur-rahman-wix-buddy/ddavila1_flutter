...
class _ChatScreenState extends State<ChatScreen> {
 ...
 bool isDeleted = false;
  ...
  String formatTimeAgo({required String utcTimeString}) {
    try {
      if (utcTimeString.isEmpty) return "";

      DateTime messageTime = DateTime.parse(utcTimeString).toUtc();
      ...
      // If parsing fails, try to handle different date formats
      try {
        // Try parsing with different format if needed
        DateTime messageTime = DateFormat("yyyy-MM-ddTHH:mm:ss.SSSSSSZ").parse(utcTimeString);
        DateTime now = DateTime.now().toUtc();
        Duration difference = now.difference(messageTime);
                ...
                builder: (context, snapshot) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final messageTime = formatTimeAgo(
                          utcTimeString:
