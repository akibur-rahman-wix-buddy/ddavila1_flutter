...
//   });
//
//   factory SellingOrderDataModel.fromRawJson(String str) => SellingOrderDataModel.fromJson(json.decode(str));
//
//   String toRawJson() => json.encode(toJson());
//
//   factory SellingOrderDataModel.fromJson(Map<String, dynamic> json) => SellingOrderDataModel(
...
//     data: json["data"] == null ? [] : List<SellerOrderDatum>.from(json["data"]!.map((x) => SellerOrderDatum.fromJson(x))),
...
//   });
//
//   factory SellerOrderDatum.fromRawJson(String str) => SellerOrderDatum.fromJson(json.decode(str));
//
//   String toRawJson() => json.encode(toJson());
//
