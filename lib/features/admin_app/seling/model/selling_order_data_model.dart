...
//   int? code;
//
//   SellingOrderDataModel({this.success, this.message, this.data, this.code});
//
//   SellingOrderDataModel.fromJson(Map<String, dynamic> json) {
...
// class Data {
//   int? currentPage;
//   List<SellerOrderDatum>? data; // Changed to List<OrderData>
//   String? firstPageUrl;
//   int? from;
//   int? lastPage;
//   String? lastPageUrl;
...
//     if (json['data'] != null) {
//       data = <SellerOrderDatum>[];
//       json['data'].forEach((v) {
//         data!.add(SellerOrderDatum.fromJson(v)); // Updated to OrderData
//       });
//     }
...
// }
//
// class SellerOrderDatum { // Renamed from Data to OrderData
//   int? id;
//   int? userId;
//   int? paymentId;
//   String? cartId;
...
//   });
//
//   SellerOrderDatum.fromJson(Map<String, dynamic> json) {
//     id = json['id'];
//     userId = json['user_id'];
...
//   String? postalCode;
//
//   ShippingAddress({this.street, this.city, this.country, this.postalCode});
//
...
//   String? unitPrice;
//   String? subtotal;
//   List<dynamic>? attributes; // Changed to List<dynamic> since Null type is not practical
//   String? createdAt;
//   String? updatedAt;
//   String? deletedAt;
//   Product? product;
...
//     attributes = json['attributes']?.cast<dynamic>();
//     createdAt = json['created_at'];
//     updatedAt = json['updated_at'];
//     deletedAt = json['deleted_at'];
...
//     data['product_bid_id'] = productBidId;
...
//     data['onboard_complete'] = onboardComplete;
//     data['country'] = country;
//     data['city'] = city;
//     data['state'] = state;
...
//     data['deleted_at'] = deletedAt;
//     data['card_attributes'] = cardAttributes;
//     return data;
//   }
// }
//
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <SellerOrderDatum>[];
      json['data'].forEach((v) {
        data!.add(SellerOrderDatum.fromJson(v));
      });
    }
    firstPageUrl = json['first_page_url'];
    from = json['from'];
...
class SellerOrderDatum {
  ...
  int? userId;
  int? paymentId;
  dynamic cartId; // Changed from String? to dynamic to handle both null and int values
  String? orderNumber;
  String? totalAmount;
  String? currency;
  String? status;
  ...
  SellerOrderDatum.fromJson(Map<String, dynamic> json) {
    ...
    userId = json['user_id'];
    paymentId = json['payment_id'];
    cartId = json['cart_id']; // Can be null or int
    orderNumber = json['order_number'];
    totalAmount = json['total_amount'];
    currency = json['currency'];
    status = json['status'];
...
class OrderItems {
  ...
  int? orderId;
  int? productId;
  dynamic productBidId; // Changed from String? to dynamic to handle null
  int? quantity;
  String? unitPrice;
  String? subtotal;
  List<dynamic>? attributes;
