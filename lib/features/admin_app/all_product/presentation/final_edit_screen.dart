...
//                         bool success =
//                             await editAuctionProductRX.updateProductAuctionRX(
...
//                             'Auction Product Update Successfully',
//                           );
//                         } else {
//                           ToastUtil.showShortToast(
//                             'Auction Product Update Failed',
//                           );
//                         }
//                       } else {
//                         log("################# Sale ####################");
...
//                         if (success) {
//                           ToastUtil.showShortToast(
//                             'Sales Product Update Successfully',
//                           );
//                         } else {
//                           ToastUtil.showShortToast(
//                             'Sales Product Update Failed',
//                           );
//                         }
//                       }
//                     },
                    ...
                    children: [
                      ...
                      CustomButton(
                        onTap: () async {
                          ...
                          List<XFile> imagees =
                              (widget.imageItem as List<dynamic>)
                                  .map((path) => XFile(path as String))
                                  .toList();
                          ...
                          if (widget.type == "auction") {
                            success = await editAuctionProductRX
                                .updateProductAuctionRX(
                              title: widget.titleText.toString(),
                              description: widget.descriptionText,
                              categoryId: widget.category,
                              subcategoryId: widget.subCategory,
                            ...
                            success = await editSellerProductAPIRX
                                .updateSaleProductsRX(
                              productId: widget.productID,
                              title: widget.titleText.toString(),
                              description: widget.descriptionText,
                              categoryId: widget.category,
