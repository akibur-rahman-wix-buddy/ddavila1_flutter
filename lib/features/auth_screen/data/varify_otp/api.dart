...
final class VerifyOtpApi {
  ...
  Future<Map<String, dynamic>> verifyOtpApi({required dynamic email, required dynamic otp}) async {
    try {
      ...
      Response response = (await postHttp(Endpoints.verificationOtpApiLink(), data));
