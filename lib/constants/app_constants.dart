...
const String kKeyIsLanguage = "language";
const String kKeyIsProfileCreated = 'is_profile_created';
const String kKeyPetID = 'pet_id';

const String onBoardingCompleted = 'onboarding_complete';
...
String remediesDetails =
    """Caring for a horse's eye health is an important part of overall equine wellness, especially during the summer months when flies and other irritants can cause issues. By properly trimming the hair around the eyes, applying a natural fly repellent, and administering colloidal silver eye drops as needed, horse owners can safely and effectively manage common eye irritations. 
Apply Dynamite Release spray to your hands and then gently rub it around the eye area.
Use an empty saline (no spray) clean, empty nose spray bottle and fill it with diluted colloidal silver. 
Apply colloidal silver eye drops directly to the horse's eye as needed to treat eye issues naturally. 
Monitor the horse's eyes regularly and repeat the colloidal silver eye drop application as necessary to address any ongoing issues.
Trim the horse's upper eyelashes/hairs short before applying a fly mask. This helps prevent gaps where dirt and debris can enter the eye.
Approach the horse calmly and slowly to avoid """;
